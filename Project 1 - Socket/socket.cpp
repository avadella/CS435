// Write a Socket Object - Vadella: socket.cpp
...
{
  struct sockaddr_in * socketInfo;                                                    // added for web server project
  ...
  unsigned char *ip = (unsigned char *)&socketInfo->sin_addr.s_addr;    //maybe this will work - noah
