// IP Forwarding: cidr.cpp - Vadella and Baker
#include "cidr.h"
#include "ip.h"
#include <cmath>
#include <vector>
...
{
    if (addr > netaddr_ && addr < bcast_)  // return the cidr mask length if address in network BUT exclude network and broadcast
    {
        // return uint_to_nm(netmask_);
        return netmaskLength_;
    }
