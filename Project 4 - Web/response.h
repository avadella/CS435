// Write an HTTP Message Object: response.h - Vadella and Baker
...
class response : public Message                                             // inherit from Message class!
{
    private:
        std::string version_;
    ...
    public:
        ...
        std::string unmarshal(unsigned char * response);                    // parse HTTP response string
};